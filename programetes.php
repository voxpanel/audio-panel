...
<title>Gerencimento de Programetes</title>
...
?>
<div id="quadro">
<div id="quadro-topo"><strong>Gerencimento de Programetes</strong></div>
<div class="texto_medio" id="quadro-conteudo">
  <table width="890" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:10px; background-color:#FFFF66; border:#DFDF00 1px solid">
    <tr>
      ...
      <td width="860" align="left" class="texto_pequeno_erro" scope="col">Selecione uma PlayLists disponíveis a baixo!</td>
    </tr>
  </table>
