...
mysql_query("Update streamings set pagina_inicial = '".$_POST["pagina_inicial"]."', idioma_painel = '".$_POST["idioma_painel"]."', timezone = '".$_POST["timezone"]."', formato_data = '".$_POST["formato_data"]."', exibir_atalhos = '".$_POST["exibir_atalhos"]."', aparencia_exibir_stats_ouvintes = '".$_POST["aparencia_exibir_stats_ouvintes"]."', aparencia_exibir_stats_ftp = '".$_POST["aparencia_exibir_stats_ftp"]."', aparencia_exibir_musica_atual = '".$_POST["aparencia_exibir_musica_atual"]."', aparencia_exibir_player = '".$_POST["aparencia_exibir_player"]."' where codigo = '".$dados_stm["codigo"]."'");

// Cadastra os atalhos
if($_POST["atalhos"]) {

// Remove os atalhos atuais
mysql_query("DELETE FROM atalhos where codigo_stm = '".$dados_stm["codigo"]."'");

foreach($_POST["atalhos"] as $ordem => $atalho) {

list($menu, $idioma) = explode("|", $atalho);

mysql_query("INSERT INTO atalhos (codigo_stm,menu,lang,ordem) VALUES ('".$dados_stm["codigo"]."','".$menu."','".$idioma."','".$ordem."')") or die("Erro ao processar query.<br>Mensagem do servidor: ".mysql_error());
...
die("<script>window.parent.location = window.parent.location.href;</script><a href='#' onclick='window.parent.location = window.parent.location.href;'>[Recarregar/Reload]</a>");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <table width="690" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:10px; background-color:#FFFF66; border:#DFDF00 1px solid">
        ...
        <td width="660" align="left" class="texto_pequeno_erro" scope="col"><?php echo $lang['lang_info_config_painel_info_hora_certa']; ?></td>
     </tr>
    </table>    </td>
  </tr>
  <tr>
        ...
        <table width="690" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#F4F4F7; border-bottom:#CCCCCC 1px solid; border-left:#CCCCCC 1px solid; border-right:#CCCCCC 1px solid;">
          <tr>
            ...
            <select name="pagina_inicial" class="input" id="pagina_inicial" style="width:255px;">
          		...
          		<option value="/ouvintes-conectados"<?php if($dados_stm["pagina_inicial"] == "/ouvintes-conectados") { echo ' selected="selected"'; } ?>><?php echo $lang['lang_info_config_painel_pagina_inicial_ouvintes']; ?></option>
         	</select>            </td>
          </tr>
          <tr>
...
<option <?php if($dados_stm["timezone"] == "Africa/Harare") { echo 'selected="selected"'; } ?> value="Africa/Harare">Harare</option>
              ...
              <table width="540" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <select name="menus" id="menus" multiple="multiple" style="width:215px; height:150px" onDblClick="moveSelectedOptions(this.form['menus'],this.form['atalhos'],false)">
					...
					<option value='streaming-configurar-relay|lang_acao_stm_config_relay'><?php echo $lang['lang_acao_stm_config_relay']; ?></option>
					<option value='streaming-players|lang_acao_stm_players'><?php echo $lang['lang_acao_stm_players']; ?></option>
					<option value='streaming-kick|lang_acao_stm_kick'><?php echo $lang['lang_acao_stm_kick']; ?></option>
					<option value='streaming-protecao|lang_acao_stm_protecao'><?php echo $lang['lang_acao_stm_protecao']; ?></option>
					<?php if($dados_stm["exibir_app_android"] == 'sim') { ?>
					<option value='streaming-app-android|lang_acao_stm_app_android'><?php echo $lang['lang_acao_stm_app_android']; ?></option>
					<?php } ?>
					<option value='streaming-multipoint|lang_acao_stm_multipoint'><?php echo $lang['lang_acao_stm_multipoint']; ?></option>
					<option value='streaming-logs-servidor|lang_acao_stm_logs_servidor'><?php echo $lang['lang_acao_stm_logs_servidor']; ?></option>
					</optgroup>
					<optgroup label="<?php echo $lang['lang_acao_label_ouvintes']; ?>">
					<option value='ouvintes-ouvintes-conectados|lang_acao_ouvintes_ouvintes_conectados'><?php echo $lang['lang_acao_ouvintes_ouvintes_conectados']; ?></option>
					<option value='ouvintes-estatisticas|lang_acao_ouvintes_stats'><?php echo $lang['lang_acao_ouvintes_stats']; ?></option>
					</optgroup>
					<optgroup label="<?php echo $lang['lang_acao_label_autodj']; ?>">
					<option value='autodj-recarregar-playlist|lang_acao_autodj_recarregar_playlist'><?php echo $lang['lang_acao_autodj_recarregar_playlist']; ?></option>
					<option value='autodj-trocar-playlist|lang_acao_autodj_trocar_playlist'><?php echo $lang['lang_acao_autodj_trocar_playlist']; ?></option>
					<option value='autodj-pular-musica|lang_acao_autodj_pular_musica'><?php echo $lang['lang_acao_autodj_pular_musica']; ?></option>
					<option value='autodj-gerenciar-musicas|lang_acao_autodj_gerenciar_musicas'><?php echo $lang['lang_acao_autodj_gerenciar_musicas']; ?></option>
					<option value='autodj-gerenciar-playlists|lang_acao_autodj_gerenciar_playlists'><?php echo $lang['lang_acao_autodj_gerenciar_playlists']; ?></option>
					<option value='autodj-gerenciar-djs|lang_acao_autodj_gerenciar_djs'><?php echo $lang['lang_acao_autodj_gerenciar_djs']; ?></option>
					<option value='autodj-gerenciar-agendamentos|lang_acao_autodj_gerenciar_agendamentos'><?php echo $lang['lang_acao_autodj_gerenciar_agendamentos']; ?></option>
					<option value='autodj-gerenciar-hora-certa|lang_acao_autodj_gerenciar_hora_certa'><?php echo $lang['lang_acao_autodj_gerenciar_hora_certa']; ?></option>
					<option value='autodj-gerenciar-vinhetas-comerciais|lang_acao_autodj_gerenciar_vinhetas_comerciais'><?php echo $lang['lang_acao_autodj_gerenciar_vinhetas_comerciais']; ?></option>
					<option value='autodj-configurar|lang_acao_autodj_config'><?php echo $lang['lang_acao_autodj_config']; ?></option>
					<option value='autodj-logs-servidor|lang_acao_autodj_logs_servidor'><?php echo $lang['lang_acao_autodj_logs_servidor']; ?></option>
					</optgroup>
					<optgroup label="<?php echo $lang['lang_acao_label_painel']; ?>">
					<option value='painel-configurar|lang_acao_painel_config'><?php echo $lang['lang_acao_painel_config']; ?></option>
					<option value='painel-api|lang_acao_painel_api'><?php echo $lang['lang_acao_painel_api']; ?></option>
					<option value='painel-logs|lang_acao_painel_logs'><?php echo $lang['lang_acao_painel_logs']; ?></option>
					...
					<option value='<?php echo $dados_revenda["lang_acao_painel_ajuda"]; ?>|XXXX'><?php echo $lang['lang_acao_painel_ajuda']; ?></option>
					<?php } ?>
					<?php if($dados_revenda["stm_exibir_downloads"] == 'sim') { ?>
					<option value='painel-downloads|lang_acao_painel_downloads'><?php echo $lang['lang_acao_painel_downloads']; ?></option>
					<?php } ?>
					</optgroup>
					<optgroup label="<?php echo $lang['lang_acao_label_ferramentas']; ?>">
					<option value='ferramentas-youtube|lang_acao_ferramentas_youtube'><?php echo $lang['lang_acao_ferramentas_youtube']; ?></option>
					<option value='ferramentas-gravador|lang_acao_ferramentas_gravador'><?php echo $lang['lang_acao_ferramentas_gravador']; ?></option>
					<option value='ferramentas-migrar-musicas|lang_acao_ferramentas_migrar_musicas'><?php echo $lang['lang_acao_ferramentas_migrar_musicas']; ?></option>
					<option value='ferramentas-renomear-musicas|lang_acao_ferramentas_renomear_musicas'><?php echo $lang['lang_acao_ferramentas_renomear_musicas']; ?></option>
					</optgroup>
					<optgroup label="<?php echo $lang['lang_acao_label_solucao_problemas']; ?>">
					<?php if($dados_stm["aacplus"] == 'sim') { ?>
					<option value='solucao-problemas-sincronizar-aacplus|lang_acao_solucao_problemas_sincronizar_aacplus'><?php echo $lang['lang_acao_solucao_problemas_sincronizar_aacplus']; ?></option>
					<?php } ?>
					...
					<option value='solucao-problemas-encoder|lang_acao_solucao_problemas_encoder'><?php echo $lang['lang_acao_solucao_problemas_encoder']; ?></option>
					<option value='solucao-problemas-diagnosticar-autodj|lang_acao_solucao_problemas_diagnosticar_autodj'><?php echo $lang['lang_acao_solucao_problemas_diagnosticar_autodj']; ?></option>
					<option value='solucao-problemas-player-cache|lang_acao_solucao_problemas_player_cache'><?php echo $lang['lang_acao_solucao_problemas_player_cache']; ?></option>
					</optgroup>
           		  </select>                  </td>
      ...
      <div class="tab-page" id="tabPage1">
        ...
        <table width="690" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#F4F4F7; border-bottom:#CCCCCC 1px solid; border-left:#CCCCCC 1px solid; border-right:#CCCCCC 1px solid;">
          <tr>
            <td width="150" height="30" align="left" class="texto_padrao_destaque" style="padding-left:5px;"><?php echo $lang['lang_info_config_painel_exibir_stats_ouvintes']; ?></td>
            <td width="540" align="left" class="texto_padrao"><input name="aparencia_exibir_stats_ouvintes" type="radio" value="sim" style="vertical-align:middle"<?php if($dados_stm["aparencia_exibir_stats_ouvintes"] == "sim") { echo ' checked="checked"'; } ?> />
              &nbsp;<?php echo $lang['lang_label_sim']; ?>&nbsp;
              <input name="aparencia_exibir_stats_ouvintes" type="radio" value="nao" style="vertical-align:middle"<?php if($dados_stm["aparencia_exibir_stats_ouvintes"] == "nao") { echo ' checked="checked"'; } ?> />
              &nbsp;<?php echo $lang['lang_label_nao']; ?>&nbsp;<img src="img/icones/ajuda.gif" title="Ajuda sobre este item." width="16" height="16" onclick="alert('<?php echo $lang['lang_info_config_painel_exibir_stats_ouvintes_info']; ?>');" style="cursor:pointer" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="150" height="30" align="left" class="texto_padrao_destaque" style="padding-left:5px;"><?php echo $lang['lang_info_config_painel_exibir_musica_atual']; ?></td>
            <td width="540" align="left" class="texto_padrao"><input name="aparencia_exibir_musica_atual" type="radio" value="sim" style="vertical-align:middle"<?php if($dados_stm["aparencia_exibir_musica_atual"] == "sim") { echo ' checked="checked"'; } ?> />
              &nbsp;<?php echo $lang['lang_label_sim']; ?>&nbsp;
              <input name="aparencia_exibir_musica_atual" type="radio" value="nao" style="vertical-align:middle"<?php if($dados_stm["aparencia_exibir_musica_atual"] == "nao") { echo ' checked="checked"'; } ?> />
              &nbsp;<?php echo $lang['lang_label_nao']; ?>&nbsp;<img src="img/icones/ajuda.gif" title="Ajuda sobre este item." width="16" height="16" onclick="alert('<?php echo $lang['lang_info_config_painel_exibir_musica_atual_info']; ?>');" style="cursor:pointer" /></td>
          </tr>
          <tr>
            <td width="150" height="30" align="left" class="texto_padrao_destaque" style="padding-left:5px;"><?php echo $lang['lang_info_config_painel_exibir_player']; ?></td>
            <td width="540" align="left" class="texto_padrao"><input name="aparencia_exibir_player" type="radio" value="sim" style="vertical-align:middle"<?php if($dados_stm["aparencia_exibir_player"] == "sim") { echo ' checked="checked"'; } ?> />
              &nbsp;<?php echo $lang['lang_label_sim']; ?>&nbsp;
              <input name="aparencia_exibir_player" type="radio" value="nao" style="vertical-align:middle"<?php if($dados_stm["aparencia_exibir_player"] == "nao") { echo ' checked="checked"'; } ?> />
              &nbsp;<?php echo $lang['lang_label_nao']; ?>&nbsp;<img src="img/icones/ajuda.gif" title="Ajuda sobre este item." width="16" height="16" onclick="alert('<?php echo $lang['lang_info_config_painel_exibir_player_info']; ?>');" style="cursor:pointer" /></td>
          </tr>
        </table>
   	  </div>
      </div></td>
