...
$promysql = mysql_query("SELECT * FROM streamings where porta  = '".$_SESSION["porta_logada"]."'");
$promysql2 = mysql_fetch_array($promysql);
if($promysql2['programetes'] == "sim"){
...
<title>Gerenciar Programetes</title>
...
<script type="text/javascript">
   window.onload = function() {
    ...
    carregar_pasta_programetes('<?php echo $porta_code; ?>');
    ...
    <table width="890" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:10px; margin-bottom:10px;">
      <tr>
        ...
        <td width="230" align="center" scope="col"><table width="200" border="0" align="center" cellpadding="0" cellspacing="0" style="border: #CCCCCC 1px solid;">
          <tr>
            <td width="" height="25" align="center" class="texto_padrao_destaque" scope="col">Gerencimento de Programetes</td>
          </tr>
          <tr>
            <td height="40" align="center" class="texto_padrao_titulo" scope="col">
            <select name="gerenciar_playlist" class="input" id="gerenciar_playlist" style="width:190px;" onchange="abrir_log_sistema();window.location = '/gerenciar-programets/'+this.value+'';">
...
?>
        ...
        <!-- gerenciador_playlists  FECHA-->
        


        <!-- Quantidade de Músicas da Playlist  -->
        <td width="230" align="center" scope="col">
          <table width="200" border="0" align="center" cellpadding="0" cellspacing="0" style="border: #CCCCCC 1px solid;" id="quadro_quantidade_musicas_playlist">
          <tr>
       ...
       <!-- Quantidade de Músicas da Playlist  FECHA-->

        <!-- gerenciador_playlists_tempo_execucao  -->
        <td width="217" align="center" scope="col">
          <table width="200" border="0" align="right" cellpadding="0" cellspacing="0" style="border: #CCCCCC 1px solid;">
          <tr>
     ...
     <!--gerenciador_playlists_tempo_execucao FECHA -->
    ...
    <table width="890" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2">
          ...
          <div style="width:372px; text-align:right; float:right; padding:5px 0px 5px 0px; overflow: auto; display: none;" class="texto_padrao_vermelho">
      ...
      <!-- GERENCIAR PROGRAMETES-->

      <tr>
        <td colspan="2" bgcolor="#00CED1">
          <div style="width:272px; text-align:left; float:left; padding:5px 0px 5px 5px; overflow: auto;" class="texto_padrao_destaque"> CATEGORIA DE PROGRAMETS </div>
          <div style="width:20px; text-align:left; float:left; padding:5px 0px 5px 5px; overflow: auto; color: #fff !important;" class="texto_padrao_destaque">  </div>
          <div style="width:372px; text-align:right; float:right; padding:5px 0px 5px 0px; overflow: auto;" class="texto_padrao_vermelho"> &nbsp;</div>
          <div style="width:200px; text-align:left; float:right; padding:5px 0px 5px 0px; overflow: auto;" class="texto_padrao_destaque"> LISTA DE BLOCOS </div>
        </td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="top">
          <div id="quadro_pastas_musicas_ftp" style="display:block">
            <div id="quadro_lista_pastas" style="background-color:#FFFFFF; border: #CCCCCC 1px solid; width:285px; height:200px; text-align:left; float:left; padding:5px; overflow: auto; resize: vertical"> <span id="status_lista_pastas_programetes" class="texto_padrao_pequeno"></span>
                <ul id="lista-pasta-programetes">
          ...
          <div id="musicas_ftp" style="background-color:#FFFFFF; border: #CCCCCC 1px solid; width:560px; height:200px; text-align:left; float:right; padding:5px; overflow: auto; resize: vertical"> <span id="msg_pasta" class="texto_padrao_pequeno"><?php echo $lang['lang_info_gerenciador_playlists_info_lista_musicas_pasta']; ?></span>
                <ul id="lista-musicas-pasta-programetes" style="list-style: none; text-decoration-style: none;">
                </ul>
          </div>
          <div style="width:297px; text-align:right; float:left; padding:5px 0px 5px 0px; overflow: auto;"> <img src="/img/icones/img-icone-atualizar.png" width="16" height="16" align="absmiddle" border="0" />&nbsp;<a href="javascript:carregar_pasta_programetes('<?php echo $porta_code; ?>');" class="texto_padrao">Carregar Pasta Programetes</a>
          </div>
          <div style="width:572px; text-align:right; float:right; padding:5px 0px 5px 0px; overflow: auto; display: none;"> 
            <img src="/img/icones/img-icone-pasta-adicionar.png" width="16" height="16" align="absmiddle" />&nbsp;<a href="javascript:adicionar_tudo();" class="texto_padrao"><?php echo $lang['lang_info_gerenciador_playlists_botao_adicionar_tudo']; ?>
              
            </a>&nbsp;&nbsp;<img src="/img/icones/img-icone-lixo.png" width="16" height="16" align="absmiddle" />&nbsp;<a href="javascript:limpar_lista_musicas('ftp');" class="texto_padrao"><?php echo $lang['lang_info_gerenciador_playlists_botao_limpar_lista']; ?></a>
          </div>
        </div></td>
      </tr>
      

<!-- GERENCIAR PROGRAMETES FECHA-->
...
<div class='div-nop'><center style='font-style: Helvetica, sans-serif; font-size:18px;'>Você não tem permissão a essa função.
 <br /> 
  <br /> 
   <br /> 
<a href='http://netstreamhost.com/' target='_blank' style='text-decoration: none; color: blue; cursor: pointer;'>Contate</a> o Suporte para mais informações.<br /> <br /><a href='/informacoes' style='text-decoration: none; color: blue; cursor: pointer;'>Voltar <i class='fas fa-chevron-left'></i></a></center></div>
<script type='text/javascript' src='/inc/javascript.js'></script>
