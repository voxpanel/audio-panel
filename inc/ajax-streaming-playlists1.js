...
function carregar_carregar_programetes_pasta( porta,pasta ) {
  ...
  var http = new Ajax();
  http.open("GET", "/admin/funcoes-ajax/carregar_programetes/"+porta+"/"+pasta , true);
  ...
  if(http.readyState == 4) {
    ...
    if(playlist == "") {  
    alert("Atenção! Você deve clicar em uma playlist abaixo para seleciona-la esta música.");  
    } else {
    nova_musica.innerHTML = "<input id='musicas_pasta' type='checkbox' value='"+dados_musica[0]+"' style='display:none' checked /><img src='/admin/img/icones/img-icone-arquivo-musica.png' border='0' align='absmiddle' />&nbsp;<a href='javascript:adicionar_uma_vinheta(\""+dados_musica[0]+"\",\""+dados_musica[1]+"\");'>"+dados_musica[1]+"</a><a href='javascript:adicionar_uma_vinheta(\""+dados_musica[0]+"\",\""+dados_musica[1]+"\");' title='Adicionar como Vinheta' style='float:right;'><img src='/admin/img/icones/img-icone-vinheta.png' width='16' height='16' alt='Adicionar como Vinheta' border='0' align='absmiddle' /></a>";
