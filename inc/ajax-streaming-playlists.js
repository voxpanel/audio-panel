...
function carregar_pasta_programetes( porta ) {
  ...
  document.getElementById("lista-pasta-programetes").innerHTML = "";
  
  document.getElementById("status_lista_pastas_programetes").innerHTML = "<img src='http://"+get_host()+"/img/ajax-loader.gif' />";
  document.getElementById("status_lista_pastas_programetes").style.display = "block";
  
  var http = new Ajax();
  http.open("GET", "/funcoes-ajax/carregar_pasta_programetes/"+porta , true);
  ...
  if(http.readyState == 4) {
	...
	nova_pasta.innerHTML = "<img src='/admin/img/icones/img-icone-pasta.png' align='absmiddle' />&nbsp;<a href='javascript:carregar_musicas_pasta_programetes(\""+porta+"\",\""+dados_pasta[0]+"\");'>"+dados_pasta[0]+"&nbsp;("+dados_pasta[1]+")</a>";
  
    document.getElementById("lista-pasta-programetes").appendChild(nova_pasta);
	
	document.getElementById("status_lista_pastas_programetes").style.display = "none";
...
function carregar_musicas_pasta_programetes( porta,pasta ) {
  ...
  document.getElementById("lista-musicas-pasta-programetes").innerHTML = "";
  ...
  var http = new Ajax();
  http.open("GET", "/funcoes-ajax/carregar_musicas_pasta_programetes/"+porta+"/"+pasta+"/"+ordenar , true);
  http.onreadystatechange = function() {
  ...
  if(http.readyState == 4) {
	...
	var path_musica = "../programentes/"+pasta+"/"+nome+"";
	var path_musica2 = "programentes/"+pasta+"";

	
	if (/[^a-z0-9_\-\. ]/gi.test(nome)) {
  
	nova_musica.innerHTML = "<img src='/img/icones/img-icone-bloqueado.png' width='16' height='16' border='0' align='absmiddle' />&nbsp;["+duracao+"] <span title='Contém acentos/Special Chars' style='color:#FF0000;'>"+nome+"</span>";
	
	nova_musica.style.backgroundColor = "#FFBFBF";
	nova_musica.style.cursor = "pointer";
	nova_musica.addEventListener("click", function(){ alert("Arquivo inválido com caracteres especiais.\n\nInvalid file with special chars.\n\nNombre de archivo no válido con caracteres especiales."); });
	
	} else {
		
	nova_musica.innerHTML = "<input id='musicas_pasta' duracao='"+duracao+"' duracao_segundos='"+duracao_segundos+"' type='checkbox' value='"+path_musica2+"' style='display:none' checked /><img src='/img/icones/img-icone-arquivo-programete.png' border='0' align='absmiddle' />&nbsp;<a href='javascript:adicionar_musica_programete_playlist(\""+path_musica+"\",\""+nome+"\",\""+duracao+"\",\""+duracao_segundos+"\");'>["+duracao+"] "+nome+"</a><span style='float:right;'><a href='javascript:play_musicaP(\""+path_musica2+"\",\""+nome+"\");' title='Play "+nome+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a>";
	
	}
  
    document.getElementById("lista-musicas-pasta-programetes").appendChild(nova_musica);
...
// Função para adicionar uma  mùsica Programete do FTP na playlist
function adicionar_musica_playlistP( path,musica,duracao,duracao_segundos ) {
...
function carregar_musicas_pasta( porta,pasta ) {
  ...
  if(http.readyState == 4) {
	...
	nova_musica.innerHTML = "<input id='musicas_pasta' duracao='"+duracao+"' duracao_segundos='"+duracao_segundos+"' type='checkbox' value='"+path_musica+"' style='display:none' checked /><img src='/admin/img/icones/img-icone-arquivo-musica.png' border='0' align='absmiddle' />&nbsp;<a href='javascript:adicionar_musica_playlist(\""+path_musica+"\",\""+nome+"\",\""+duracao+"\",\""+duracao_segundos+"\");'>["+duracao+"] "+nome+"</a><span style='float:right;'><a href='javascript:play_musica(\""+porta+"\",\""+path_musica+"\");' title='Play "+nome+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:adicionar_vinheta(\""+path_musica+"\",\""+nome+"\",\""+duracao+"\",\""+duracao_segundos+"\");' title='Intercalar/Interleave' style='padding-right:5px;'><img src='/admin/img/icones/img-icone-vinheta.png' width='16' height='16' alt='Intercalar/Interleave' border='0' align='absmiddle' /></a>";
...
function carregar_musicas_playlist( playlist ) {
  ...
  if(http.readyState == 4) {
	...
	nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|musica' style='display:none' checked /><img src='/img/icones/img-icone-arquivo-musica.png' border='0' align='absmiddle' />&nbsp;["+duracao+"] "+path.replace("/", " » ")+"<span style='float:right;'><a href='javascript:play_musica(\""+porta+"\",\""+path+"\");' title='Play "+musica+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")' style='float:right;'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover/Remove' title='Remover' border='0' align='absmiddle' /></a></span>";
	
	}else if(tipo == "programete") {
	
	nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|programete' style='display:none' checked /><img src='/img/icones/img-icone-arquivo-programete.png' border='0' align='absmiddle' />&nbsp;<span style='color:#f90;'>["+duracao+"] "+path.replace("/", " » ")+"</span><span style='float:right;'><a href='javascript:play_musicaP(\""+porta+"\",\""+path+"\");' title='Play "+musica+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")' style='float:right;'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover/Remove' title='Remover' border='0' align='absmiddle' /></a></span>";
	

	} else if(tipo == "vinheta") {
	
	nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|vinheta' style='display:none' checked /><img src='/img/icones/img-icone-vinheta.png' border='0' align='absmiddle' />&nbsp;<span class='lista-musicas-playlist-vinheta'>["+duracao+"] "+path.replace("/", " » ")+"</span><span style='float:right;'><a href='javascript:play_musica(\""+porta+"\",\""+path+"\");' title='Play "+musica+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")' style='float:right;'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover' title='Remover/Remove' border='0' align='absmiddle' /></a></span>";
	
	} else if(tipo == "comercial") {
	
	nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|comercial' style='display:none' checked /><img src='/img/icones/img-icone-vinheta.png' border='0' align='absmiddle' />&nbsp;<span class='lista-musicas-playlist-comercial'>["+duracao+"] "+path.replace("/", " » ")+"</span><span style='float:right;'><a href='javascript:play_musica(\""+porta+"\",\""+path+"\");' title='Play "+musica+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")' style='float:right;'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover' title='Remover/Remove' border='0' align='absmiddle' /></a></span>";
	
	} else if(tipo == "intercalado") {
	
	nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|intercalado' style='display:none' checked /><img src='/img/icones/img-icone-musica-intercalado.png' border='0' align='absmiddle' />&nbsp;<span class='lista-musicas-playlist-intercalado'>["+duracao+"] "+path.replace("/", " » ")+"</span><span style='float:right;'><a href='javascript:play_musica(\""+porta+"\",\""+path+"\");' title='Play "+musica+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")' style='float:right;'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover' title='Remover/Remove' border='0' align='absmiddle' /></a></span>";
	
	} else {
	
	nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|hc' style='display:none' checked /><img src='/img/icones/img-icone-hora-certa.png' border='0' align='absmiddle' />&nbsp;<span class='lista-musicas-playlist-hora-certa'>["+duracao+"] "+musica+"</span><span style='float:right;'><a href='javascript:play_musica(\""+porta+"\",\""+path+"\");' title='Play "+musica+"'><img src='/img/icones/img-icone-relay.png' width='16' height='16' border='0' style='padding-right:5px;' align='absmiddle' /></a><a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover' title='Remover/Remove' border='0' style='padding-right:5px;' align='absmiddle' /></a></span>";
...
// Função para adicionar uma musica do FTP na playlist
function adicionar_musica_programete_playlist( path,musica,duracao,duracao_segundos ) {
  ...
  nova_musica.innerHTML = "<input name='musicas_adicionadas[]' type='checkbox' value='"+path+"|"+musica+"|"+duracao+"|"+duracao_segundos+"|programete' style='display:none' checked /><img src='/img/icones/img-icone-arquivo-programete.png' border='0' align='absmiddle' />&nbsp;["+duracao+"] "+path.replace("/", " » ")+"<a href='javascript:remover_musica(\""+novo_id+"\",\""+duracao_segundos+"\")' style='float:right;'><img src='/admin/img/icones/img-icone-fechar.png' width='16' height='16' alt='Remover' title='Remover' border='0' align='absmiddle' /></a>";
...
function play_musicaP( porta, musica ) {
  ...
  var http = new Ajax();
  http.open("GET", "/funcoes-ajax/play_musicaP/"+porta+"/"+musica , true);
  http.onreadystatechange = function() {
