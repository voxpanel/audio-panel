...
<div id="quadro-topo"><strong><?php echo lang_info_players_tab_players; ?></strong></div>
 <div class="texto_medio" id="quadro-conteudo">
    ...
    <tr>
      ...
      <div id="quadro">
            	<div id="quadro-topo"> <strong><?php echo lang_info_players_player_computador; ?></strong></div>
            		<div class="texto_medio" id="quadro-conteudo">
                    <table width="870" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td width="290" height="25" align="center" class="texto_padrao"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/winamp.pls"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-winamp.png" width="32" height="32" border="0" /></a><br />
      <br />
      <textarea name="textarea2" readonly="readonly" style="width:280px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/winamp.pls"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-winamp.png" width="32" height="32" title="Ouvir no Winamp" /></a></textarea></td>
    <td width="290" align="center" class="texto_padrao"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/mediaplayer.asx"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-mediaplayer.png" width="32" height="32" border="0" /></a><br />
      <br />
      <textarea name="textarea3" readonly="readonly" style="width:280px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/mediaplayer.asx"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-mediaplayer.png" width="32" height="32" title="Ouvir no MediaPlayer" /></a></textarea></td>
    <td width="290" align="center" class="texto_padrao"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/realplayer.rm"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-realplayer.png" width="32" height="32" border="0" /></a><br />
      <br />
      <textarea name="textarea4" readonly="readonly" style="width:280px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/realplayer.rm"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-realplayer.png" width="32" height="32" title="Ouvir no RealPlayer" /></a></textarea></td>
  </tr>
  <tr>
    <td height="5" colspan="3" align="center" class="texto_padrao">&nbsp;</td>
    </tr>
  <tr>
    <td width="290" align="center" class="texto_padrao"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/vlc.m3u"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-vlc.png" width="32" height="32" border="0" /></a><br />
        <br />
        <textarea name="textarea4" readonly="readonly" style="width:280px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/vlc.m3u"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-vlc.png" width="32" height="32" title="Ouvir no RealPlayer" /></a></textarea></td>
    <td width="290" align="center" class="texto_padrao"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/quicktime.qtl"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-qt.png" width="32" height="32" border="0" /></a><br />
        <br />
        <textarea name="textarea4" readonly="readonly" style="width:280px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo $url_player; ?>/player/<?php echo $dados_stm["porta"]; ?>/quicktime.qtl"><img src="http://<?php echo $host_sources; ?>/img/icones/img-icone-player-qt.png" width="32" height="32" title="Ouvir no RealPlayer" /></a></textarea></td>
