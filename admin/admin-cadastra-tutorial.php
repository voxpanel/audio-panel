...
mysql_query("INSERT INTO tutoriais (titulo,data,tutorial) VALUES ('".$_POST["titulo"]."',NOW(),'".addslashes($tutorial)."')") or die("Erro ao processar query.<br>Mensagem do servidor: ".mysql_error());
