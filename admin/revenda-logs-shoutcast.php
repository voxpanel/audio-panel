...
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:5px; margin-left:0 auto; margin-right:0 auto; background-color: #C1E0FF; border: #006699 1px solid">
  <tr>
    ...
    <td width="660" align="left" class="texto_padrao_destaque" scope="col"><?php echo lang_info_logs_shoutcast_info; ?></td>
  </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      ...
      <div id="quadro">
            	<div id="quadro-topo"> <strong><?php echo lang_info_logs_shoutcast_tab_titulo; ?></strong></div>
